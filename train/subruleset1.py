...
class SubRuleSet1:
    def __init__(self, input_vars, output_vars, cached_vars):
        ...
        def condition6(self: SubRuleSet1):
            return F(self.state[self.index_8] * self.p_8 + self.p_9)
    ...
    def write_back(self, action):
        table = [["side_distance"], ["side_distance"], ["combatStage"], [], ["combatStage"], [], []]
