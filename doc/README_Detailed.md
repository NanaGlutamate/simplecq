# SimpleCQ Detailed Engine Guide

This document provides extended notes on SimpleCQ engine operation, assembled-model restart, scenario routing rules, profiling, visualization, and source layout.
